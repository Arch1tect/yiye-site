...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		...
		{ src:'images/bg-slider/leaf.jpg', fade:1000 },
		// { src:'images/bg-slider/Connected_Wellness_Ecosystem.jpg', fade:1000 },
		// { src:'images/bg-slider/chat_done.jpg', fade:1000 },
		// { src:'images/bg-slider/profile_new_done.png', fade:1000 },
		// { src:'images/bg-slider/graph_done.png', fade:1000 },
		// { src:'images/bg-slider/danmu_done.jpg', fade:1000 },
...
$(document).ready(function() {
	...
	$('form.contact-form').on('submit', function(e) {
		...
		data_to_send.from = $('#email').val();
		data_to_send.subject = $('#subject').val();
		data_to_send.text = $('#message').val();

		$.ajax({
		    // url: "https://api.mailgun.net/v3/sandboxd1b6c36cfcee4a788c1d9794208e7583.mailgun.org/messages",
		    url: "/form-submit",
		    // beforeSend: function(xhr) { 
		    //   xhr.setRequestHeader("Authorization", "Basic " + btoa("api:key-c5e95173a1f60ab411eff18031723799")); 
		    // },
		    // headers: {"Authorization": "Basic "+btoa("api:key-c5e95173a1f60ab411eff18031723799")},
		    // username: 'api',
		    // password: 'key-c5e95173a1f60ab411eff18031723799',
		    type: 'POST',
